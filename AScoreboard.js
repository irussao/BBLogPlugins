	...
	*/
    ...
    drawPlayerScoreBoard : function(instance, scoreboardData) 
    {
        ...
        */
		...
		// s.gameMode = 524288 ctf remover tickets bar e apenas mostrar pontos do lado da flag
		// teams[1].status.flags s.teams[id]flags  s.gameMode = 524288
        ...
        for( i = 0; i < teams.length; i++ )
        {
			...
			// instance.debug("teamcount " + teamcount);
    ...
    createAdvancedPlayerView : function(instance, personaId, displayDefault){
        ...
        if(!instance.playerStats.hasOwnProperty(personaId)) {
			...
			// console.log(pStats.overviewStats);
